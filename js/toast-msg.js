...
function testToastMessages() {
    ...
    // Trigger an error toast after 1 second
    setTimeout(() => {
        showToast("This is an error message!", "error");
    }, 1000);

    // Trigger a warning toast after 2 seconds
    setTimeout(() => {
        showToast("This is a warning message!", "warning");
    }, 2000);

    // Optionally: Trigger a custom message to see default behavior
    setTimeout(() => {
        showToast("This is a default message (no type)!");
    }, 3000);
}
